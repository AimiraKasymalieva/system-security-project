...
URL = "http://127.0.0.1:8000/data/send-encrypted"
...
encrypted_payload = encrypt_payload(original_payload)

signature = sign_data(PRIVATE_KEY, encrypted_payload.encode("utf-8"))
...
tampered_encrypted_payload = encrypted_payload[:-5] + "abcde"

print("=== TAMPERED ENCRYPTED REQUEST ===")
